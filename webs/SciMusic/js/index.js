...
var Fm = {
  ...
  updateStatus() {
    ...
    max = Math.floor(this.audio.duration / 60)
    max_sec = Math.floor(Fm.audio.duration % 60)
    this.$container.find('.current-time').text(min + ':' + second + '/' + max + ':' + max_sec)
    // 设置进度条
